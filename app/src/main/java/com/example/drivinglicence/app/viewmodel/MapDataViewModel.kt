...
class MapDataViewModel : BaseViewModel() {
    ...
    var mapAnswerImportant = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    var mapAnswerConceptsAndRules = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    var mapAnswerCulturesAndEthics = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    var mapAnswerDrivingUnique = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    var mapAnswerRoadSign = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    var mapAnswerSatFigure = kotlin.collections.HashMap<Int, MutableList<Answer>>()
    val mapping: MutableMap<Int, MutableList<Answer>> = mutableMapOf()
    val mapQuestion = kotlin.collections.HashMap<Int, MutableList<Question>>()
    ...
    private fun getAnswerWithQuestionImportant() {
        for (i in 1..35) {
            mapAnswerImportant[i] set listAnswerImportant[i - 1]
        }
    }
    ...
    private fun getAnswerWithQuestionConcepts() {
        for (i in 1..30) {
            mapAnswerConceptsAndRules[i + 40] set listAnswerConceptAndRule[i - 1]
        }
    }
    ...
    private fun getAnswerWithQuestionCulturesAndEthics() {
        for (i in 1..5) {
            mapAnswerCulturesAndEthics[i + 80] set listAnswerCultureAndEthic[i - 1]
        }
    }
    ...
    private fun getAnswerWithQuestionDrivingUnique() {
        for (i in 1..12) {
            mapAnswerDrivingUnique[i + 90] set listAnswerDrivingUnique[i - 1]
        }
    }
    ...
    private fun getAnswerWithQuestionRoadSign() {
        for (i in 1..20) {
            mapAnswerRoadSign[i + 110] set listAnswerRoadSign[i - 1]
        }
    }
    ...
    private fun getAnswerWithQuestionSatFigure() {
        for (i in 1..20) {
            mapAnswerSatFigure[i + 140] set listAnswerSatFigure[i - 1]
        }
    }
